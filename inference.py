...
class SadTalker():
    ...
    def __init__(args, checkpoint_path='checkpoints', config_path='src/config', lazy_load=False):
    ...
    def main(args):
        ...
        sadtalker_paths = init_path(args.checkpoint_path, os.path.join(current_root_path, 'src/config'), args.size, args.old_version, args.preprocess)
